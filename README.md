...
## Clone Diem repository
     ...
     git clone git@gitlab.com:les-echos-publishing/diem/diem.git --recursive
     
If you didn't use `--recursive` while cloning, you can manually update submodules like so :
