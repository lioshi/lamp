...
RUN apt-get update 
RUN apt-get -y install supervisor git apache2 libapache2-mod-php5 mysql-server php5-mysql php5-curl pwgen php5-mcrypt php5-intl php5-imap vim graphviz nodejs npm parallel
